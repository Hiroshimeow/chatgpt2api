        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">为系统中的出站请求Cấu hình统一代理，保存后会立即生效。</p>
            </div>
          </div>
          <Badge variant={proxy.trim() ? "success" : "secondary"} className="w-fit rounded-md px-2.5 py-1">
            {proxy.trim() ? "已Cấu hình" : "未Cấu hình"}
          </Badge>
        </div>
          ...
          <>
            <div className="space-y-2">
              ...
              <p className="text-sm text-stone-500">
                Để trống nếu không dùng proxy.请按完整地址填写，例如 `http://127.0.0.1:7890`、`http://用户名:密码@127.0.0.1:7890` 或 `socks5://127.0.0.1:7890`。
              </p>
            </div>
